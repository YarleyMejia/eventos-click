...
/*
Esta clase proporciona métodos para subir y eliminar imágenes en Firebase Storage. El método
subirImagen() genera un nombre único para el archivo, lo sube al bucket y retorna su URL
pública. El método eliminarImagen() obtiene el blob correspondiente al nombre de la imagen y
